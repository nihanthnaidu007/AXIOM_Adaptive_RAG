> Source: Obvious artifact `art_jV2n9Tta` — “Production Upgrade — Delivery Dossier (Four Repos)” · exported 2026-09-17
...
- [x] Scale: Postgres-backed trace store and eval jobs; backend Dockerfile + full-stack compose profile — migration `c4d8e2f6a9b1` in the Alembic chain; non-root image with healthcheck
